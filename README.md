...
Login/registration and saved login state; AI import, review, place editing, validation and multi-day confirmation; trip viewing/editing/reordering; route map, transport links and Google Maps navigation; profile and import notifications. I also fixed Mobile navigation issues and added Mobile tests, lint/code-scanning follow-up and network settings. Details in [MOBILE_CONTRIBUTION.md](MOBILE_CONTRIBUTION.md).
